...
The final result is a working ECS Fargate deployment for Memos, a lightweight note-taking application.

The project includes a custom Docker image, Amazon ECR, ECS Fargate, an Application Load Balancer, HTTPS with ACM, Route 53 DNS, Terraform-managed infrastructure, remote state locking, and GitHub Actions workflows for CI/CD.

Deployment URL used during testing:
